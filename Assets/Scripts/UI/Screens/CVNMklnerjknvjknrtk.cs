    ...
    public class CVNMklnerjknvjknrtk : Bnjwkenjkrnjwe
    {
        ...
        public void StartGame()
        {
            ...
            _canvas.ChangeScreen<Bmkmfkweklnmjkvrtl, GamePayload>(
                new GamePayload() { SelectedLevel = _bnjkwenrjkwe.LastLevelIndex }
            );
            _canvas.ChangeScreen<Bmkmfkweklnmjkvrtl, GamePayload>(new GamePayload { SelectedLevel = _bnjkwenrjkwe.LastLevelIndex });
        }
